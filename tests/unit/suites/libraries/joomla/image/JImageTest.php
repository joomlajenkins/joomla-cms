...
class JImageTest extends TestCase
{
	...
	{
		$outFileGif = JPATH_TESTS . '/tmp/out.' . uniqid() . '.gif';
	...
	{
		$outFilePng = JPATH_TESTS . '/tmp/out.' . uniqid() . '.png';
	...
	public function testToFileJpg()
	{
		...
		$outFileJpg = JPATH_TESTS . '/tmp/out.' . uniqid() . '.jpg';
	...
	{
		// Write the file out to a JPG.
		$outFileDefault = JPATH_TESTS . '/tmp/out.' . uniqid() . '.default';
